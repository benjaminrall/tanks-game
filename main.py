...
tiles = [pygame.image.load("tiles\dirt_1.png"),pygame.image.load("tiles\dirt_2.png"),pygame.image.load("tiles\grass_1.png"),
         ...
         pygame.image.load("tiles\dirt_border_square_up.png"),pygame.image.load("tiles\dirt_border_top_left.png"),
         pygame.image.load("tiles\dirt_border_top_right.png"),pygame.image.load("tiles\grass_border_square_bottom_left.png"),
